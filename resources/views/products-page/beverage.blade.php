                                    ...
                                    <div class="col-7">
                                        ...
                                        <div class="d-flex justify-content-between align-items-center">
                                            <div class="btn-group">
                                                ...
                                                @else
                                                    <a href="{{ route('keep.product', ['id_produk' => $b->id, 'nama_produk' => $b->nama_produk, 'harga' => $b->harga, 'seller' => $b->seller_id]) }}"
            ...
            @else
                ...
                <div class="col-md-6">
                    <div class="blank-page">
                        ...
                        <button onclick="window.history.back()" class="btn btn-secondary" style="width: 50%">Cek yang
                            lain.</button>
                    </div>
                </div>
                <div class="col-md-3"></div>
