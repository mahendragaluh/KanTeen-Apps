            ...
            <div class="card mb-4 shadow-sm">
                <div class="card-body">
                    ...
                    <div class="row no-gutters">
                        <div class="col-4">
                            <button data-toggle="modal" data-target="#view{{ $o }}" style="border-radius: 0"
                                class="btn btn-secondary btn-block">View</button>
                        </div>
                        <div class="col-8">
                            @if ($ord->status == 'queue')
                                <a href="{{ route('cook', ['id' => $ord->id]) }}" style="border-radius: 0"
                                    class="btn btn-primary btn-block">Cook</a>
                            @elseif ($ord->status == 'cooking')
                                <a href="{{ route('finish', ['id' => $ord->id]) }}" style="border-radius: 0"
                                    class="btn btn-success btn-block">Finish</a>
                            @endif
                        </div>
                    </div>
                </div>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <a href="{{ route('tolak.pesanan', ['id' => $ord->id]) }}"
                                class="btn btn-danger btn-block">Tolak Pesanan</a>
                        </div>
                    </div>
                </div>
